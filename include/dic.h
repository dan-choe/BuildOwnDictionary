...
char DEFAULT_DICT_FILE[MAX_SIZE];
FILE* DEFAULT_INPUT;//= stdin; error
FILE* DEFAULT_OUTPUT;//= stdout; error
...
/**
 * @brief      Print all correct & misspelled words in new dictionary file
 */
